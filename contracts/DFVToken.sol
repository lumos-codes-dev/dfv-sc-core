...
contract DFVToken is ERC20, ERC20Permit, ERC20Votes {
     ...
     */
    constructor(address vesting_, address uni_, address dao_) ERC20("DFV Token", "DFV") ERC20Permit("DFV Token") {
        // Blind Believers vesting pool 20,828,377,491.30
        _mint(vesting_, 20_828_377_491_300_000_000_000_000_000);
        // UNI V3 DFV/USDT 117,334,651,306.91
        _mint(uni_, 117_334_651_306_910_000_000_000_000_000);
        // DAO 491,353,345.96
